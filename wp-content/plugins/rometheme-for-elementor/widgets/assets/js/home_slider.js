jQuery(window).on("elementor/frontend/init", function () {
  elementorFrontend.hooks.addAction(
    "frontend/element_ready/rkit-home-slider.default",
    function ($scope, $) {
      ...
      swiper.on("slideChangeTransitionStart", function () {
        ...
        const activeSlideSubTitleSection = document.querySelector(
          ".swiper-slide-active .hs-subtitle-section"
        );

        if (activeSlideSubTitleSection) {
          const activeSlideSubTitle =
            activeSlideSubTitleSection.querySelector(".hs-sub-title");
          const iconElement =
            activeSlideSubTitleSection.querySelector(".icon-subtitle-hs");
        ...
        const activeSlideTitle = document.querySelector(
          ".swiper-slide-active .hs-animation-1-title"
        );
        ...
        // desc
        const activeSlideDesc = document.querySelector(
          ".swiper-slide-active .hs-animation-1-desc"
        );
        ...
        // typewriter
        const activeSlideTextSubtitle = document.querySelector(
          ".swiper-slide-active .hs-animation-2-subtitle"
        );
        ...
        if (activeSlideTextSubtitle) {
          ...
          activeSlideTextSubtitle.style.animation =
            "typewritersubtitle 4s steps(30) 1s forwards, blink 0.7s step-end infinite";
        }

        const activeSlideTextTitle = document.querySelector(
          ".swiper-slide-active .hs-animation-2-title"
        );

        if (activeSlideTextTitle) {
          activeSlideTextTitle.style.animation = "none";
          void activeSlideTextTitle.offsetWidth; // Trigger reflow
          activeSlideTextTitle.style.animation =
            "typewritertitle 4s steps(30) 1s forwards, blink 0.7s step-end infinite";
        }

        const activeSlideTextDesc = document.querySelector(
          ".swiper-slide-active .hs-animation-2-desc"
        );

        if (activeSlideTextDesc) {
          activeSlideTextDesc.style.animation = "none";
          void activeSlideTextDesc.offsetWidth; // Trigger reflow
          activeSlideTextDesc.style.animation =
            "typewriterdesc 4s steps(30) 1s forwards, blink 0.7s step-end infinite";
        }
      });
    }
  );
